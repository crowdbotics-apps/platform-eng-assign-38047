...
## Project Structure
    ...
    ├── platform_eng_assign_38047  # Django project configurations
...
1. Clone this repo and `cd platform_eng_assign_38047`
...
2. Clone this repo and `cd platform_eng_assign_38047`
